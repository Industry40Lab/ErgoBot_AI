...
class YOLOXDetector(BaseDetector):
    def __init__(self, cfg, opt=None):
        ...
        # self.model_weights = cfg.get("MODEL_WEIGHTS", "/home/shayan/projects/AlphaPose/detector/yolox/data/yolox_x.pth")
        self.model_weights = "/home/shayan/projects/AlphaPose/detector/yolox/data/yolox_x.pth"
