...
class RealsenseDetectionLoader():
    def __init__(self, detector, cfg, opt, queueSize=1, device_name = None):
        self.cfg = cfg
        self.opt = opt
        self.device = 0
    ...
    def frame_preprocess(self):
        ...
        if self.device_name is not None:
            self.config.enable_device(self.device_name)
        # Enable IMU streams (gyro & accel for RoT data)
       ...
       # Configure RealSense pipeline
        self.width , self.height, self.fps= 640, 480, 60
