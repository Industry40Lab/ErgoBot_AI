...
class SkillImpl(Node):
    ...
    def __init__(self) -> None:
        """Construct the node."""
        super().__init__('skill_say_skill')
        ...
        self._notif_pub = None

        self._last_msg = ""  # for diagnostics

        self.get_logger().info('Skill say_skill started, but not yet configured.')
    ...
    def run_skill(self, msg):
        ...
        new_msg = String()
        new_msg.data = msg
        self._notif_pub.publish(new_msg)
    ...
    def on_configure(self, state: State) -> TransitionCallbackReturn:
        ...
        self._notif_pub = self.create_publisher(String, '/speak_text', 10 )
        ...
        self.get_logger().info("Skill say_skill is configured, but not yet active")
    ...
    def on_activate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill say_skill is active and running")
    ...
    def on_deactivate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill say_skill is stopped (inactive)")
        return super().on_deactivate(state)

    def on_shutdown(self, state: State) -> TransitionCallbackReturn:
        self.get_logger().info('Shutting down say_skill skill.')
        ...
        self.get_logger().info("Skill say_skill finalized.")
        return TransitionCallbackReturn.SUCCESS
    ...
    def publish_diagnostics(self):
        ...
        msg = DiagnosticStatus(
            ...
            name="/skills/say",
            message="skill say_skill is running",
            values=[
                KeyValue(key="Module name", value="say_skill"),
