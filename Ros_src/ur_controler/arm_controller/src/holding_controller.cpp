...
class NormalNode : public rclcpp::Node{
    ...
    public:
        NormalNode(std::shared_ptr<arm_controller::MoveRobotClass>  robot):Node("subscriber_node"), robot{robot} {
            ...
            "/movement_order_rpk", 1,std::bind(&NormalNode::user_command_analyzis,this,std::placeholders::_1));  
    ...
    void user_command_analyzis(const std_msgs::msg::String::SharedPtr msg)
    {
        ...
        if (pos != std::string::npos) {
            ...
            RCLCPP_INFO(this->get_logger(), "Direction: '%s'", part1.c_str());
            RCLCPP_INFO(this->get_logger(), "amount: '%s'", part2.c_str());
            
            
            std::cout << "Recieved number in string: " << part2 << std::endl;
            float num = std::stof(part2);
            std::cout << "Recieved number in float" << num << std::endl;
            ...
            std::cout << "Position x change value: " << x << std::endl;
            std::cout << "Position y change value: " << y << std::endl;
            std::cout << "Position z change value: " << z << std::endl;
        ...
        // }
            ...
            RCLCPP_WARN(this->get_logger(), "Incorrect Format.");
        }
    }
